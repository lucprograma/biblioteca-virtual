...
import { login, register,updateProfile,deleteProfile ,deleteThis, logout} from '../controllers/auth.controller.js';
...
router.patch('/profile', chkToken, validateSchema(patchUserSchema), updateProfile);
...
router.post('/logout', chkToken, logout);
